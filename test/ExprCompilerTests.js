...
describe("ExprCompiler", function() {
  beforeEach(function() {
    ...
    return this.compile = (expr, expected) => {
  ...
  it("compiles jsonql primaryKey", function() {
    const schema = new Schema().addTable({ id: "tpk", name: { en: "T1" }, primaryKey: { type: "field", tableAlias: "{alias}", column: "primary" }, contents: [
  ...
  describe("ops", function() {
    ...
    it("compiles -", function() {
      this.compile(
        ...
        },
        {
          type: "op",
          op: "-",
          exprs: [{ type: "op", op: "::decimal", exprs: [this.number1JsonQL] }, { type: "op", op: "::decimal", exprs: [this.number2JsonQL] }]
        }
      );
    ...
    it("compiles /, avoiding divide by zero which is fatal", function() {
      this.compile(
        ...
        },
        {
          type: "op",
          op: "/",
          exprs: [this.number1JsonQL, { type: "op", op: "::decimal", exprs: [{ type: "op", op: "nullif", exprs: [this.number2JsonQL, 0] }] }]
        }
      );
    ...
    it("compiles last where", function() {
      const text = { type: "field", table: "t2", column: "text" };
      const textJsonQL = { type: "field", tableAlias: "T1", column: "text" };
      const cond = { type: "op", op: ">", exprs: [{ type: "field", table: "t2", column: "number" }, { type: "literal", valueType: "number", value: 3 }] };
      const condJsonQL = { type: "op", op: ">", exprs: [{ type: "field", tableAlias: "T1", column: "number" }, { type: "literal", value: 3 }] };
    ...
    it("compiles percent where with of", function() {
      ...
      const cond2 = { type: "op", op: ">", exprs: [{ type: "field", table: "t2", column: "number" }, { type: "literal", valueType: "number", value: 2 }] };
      const cond2JsonQL = { type: "op", op: ">", exprs: [{ type: "field", tableAlias: "T1", column: "number" }, { type: "literal", value: 2 }] };
          ...
          exprs: [
            {
              ...
              op: "-",
              exprs: [
                { type: "op", op: "date_part", exprs: ['epoch', { type: "op", op: "::timestamp", exprs: [this.datetime1JsonQL] }]},
                { type: "op", op: "date_part", exprs: ['epoch', { type: "op", op: "::timestamp", exprs: [this.datetime2JsonQL] }]}
              ]
            },
            86400
          ]
        ...
        return this.compile(
          ...
          },
          {
            ...
            exprs: [
              ...
              { type: "op", op: "<", exprs: [this.date1JsonQL, moment().startOf('year').add(1, "years").format("YYYY-MM-DD")]}
            ]
          }
        );
      });
      ...
      it("lastyear", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.date1JsonQL, moment().startOf('year').subtract(1, "years").format("YYYY-MM-DD")]},
              { type: "op", op: "<", exprs: [this.date1JsonQL, moment().startOf('year').format("YYYY-MM-DD")]}
            ]
          }
        );
        ...
        return this.compile(
          ...
          },
          {
            ...
            exprs: [
              ...
              { type: "op", op: "<", exprs: [this.date1JsonQL, moment().startOf('month').add(1, "months").format("YYYY-MM-DD")]}
            ]
          }
        );
      });
      ...
      it("lastmonth", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.date1JsonQL, moment().startOf('month').subtract(1, "months").format("YYYY-MM-DD")]},
              { type: "op", op: "<", exprs: [this.date1JsonQL, moment().startOf('month').format("YYYY-MM-DD")]}
            ]
          }
        );
        ...
        return this.compile(
          ...
          },
          {
            ...
            exprs: [
              ...
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf('year').add(1, "years").toISOString()]}
            ]
          }
        );
      });
      ...
      it("lastyear", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().startOf('year').subtract(1, "years").toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf('year').toISOString()]}
            ]
          }
        );
        ...
        return this.compile(
          ...
          },
          {
            ...
            exprs: [
              ...
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf('month').add(1, "months").toISOString()]}
            ]
          }
        );
      });
      ...
      it("lastmonth", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().startOf('month').subtract(1, "months").toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf('month').toISOString()]}
            ]
          }
        );
        ...
        return this.compile(
          ...
          },
          {
            ...
            exprs: [
              ...
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").add(1, "days").toISOString()]}
            ]
          }
        );
      });
      ...
      it("yesterday", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().startOf("day").subtract(1, "days").toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").toISOString()]}
            ]
          }
        );
      ...
      it("last7days", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().startOf("day").subtract(7, "days").toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").add(1, "days").toISOString()]}
            ]
          }
        );
      ...
      it("last30days", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().startOf("day").subtract(30, "days").toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").add(1, "days").toISOString()]}
            ]
          }
        );
      ...
      it("last365days", function() {
        this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().startOf("day").subtract(365, "days").toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").add(1, "days").toISOString()]}
            ]
          }
        );
        ...
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().subtract(2, "months").startOf('month').toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").add(1, "days").toISOString()]}
            ]
          }
        );
      ...
      it("last6months", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().subtract(5, "months").startOf('month').toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").add(1, "days").toISOString()]}
            ]
          }
        );
      ...
      it("last12months", function() {
        return this.compile(
          ...
          },
          {
            ...
            op: "and",
            exprs: [
              { type: "op", op: ">=", exprs: [this.datetime1JsonQL, moment().subtract(11, "months").startOf('month').toISOString()]},
              { type: "op", op: "<", exprs: [this.datetime1JsonQL, moment().startOf("day").add(1, "days").toISOString()]}
            ]
          }
        );
    ...
    it("distance", function() {
      return this.compile(
        ...
        // ST_DistanceSphere(ST_Transform(x, 4326::integer), ST_Transform(y, 4326::integer))
        {
          ...
          exprs: [
            { type: "op", op: "ST_Transform", exprs: [this.geometryJsonQL, { type: "op", op: "::integer", exprs: [4326] }] },
            { type: "op", op: "ST_Transform", exprs: [this.geometryJsonQL, { type: "op", op: "::integer", exprs: [4326] }] }
          ]
        }
      );
  ...
  describe("custom jsonql", function() {
    describe("table", () => it("substitutes table", function() {
      ...
      const jql = ec.compileExpr({expr: { type: "scalar", table: "t1", joins: ["1-2"], expr: { type: "field", table: "t2", column: "number" } }, tableAlias: "T1"});
    ...
    // describe "join"
    return describe("column", () => it("substitutes {alias}", function() {
  ...
  describe("logicals (deprecated)", function() {
    ...
    it("compiles logical", function() {
      const expr1 = { type: "comparison", op: "=", lhs: { type: "field", table: "t1", column: "number" }, rhs: { type: "literal", valueType: "number", value: 3 } };
  ...
  return describe("extension", () => it("compiles", function() {
