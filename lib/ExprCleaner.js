...
module.exports = ExprCleaner = (function() {
  ...
  ExprCleaner.prototype.cleanExpr = function(expr, options) {
    var aggrs, args, booleanOnly, i, k, opItem, ref, ref1, type;
    if (options == null) {
      options = {};
    }
    _.defaults(options, {
    ...
    if (this.exprUtils.getExprAggrStatus(expr) === "individual" && indexOf.call(options.aggrStatuses, "individual") < 0 && indexOf.call(options.aggrStatuses, "aggregate") >= 0) {
      aggrs = this.exprUtils.getAggrs(expr);
      if (aggrs.length > 0) {
        expr = {
          type: "op",
          op: aggrs[0].id,
    ...
    if (this.exprUtils.getExprAggrStatus(expr) && (ref = this.exprUtils.getExprAggrStatus(expr), indexOf.call(options.aggrStatuses, ref) < 0)) {
      return null;
    }
  ...
  ExprCleaner.prototype.cleanOpExpr = function(expr, options) {
    var aggr, enumValueIds, enumValues, exprs, innerAggrStatuses, lhsExpr, opItem, opItems, ref, ref1, ref2;
    switch (expr.op) {
      case "and":
      case "or":
        expr = _.extend({}, expr, {
