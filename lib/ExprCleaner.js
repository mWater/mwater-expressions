...
module.exports = ExprCleaner = (function() {
  function ExprCleaner(schema, variables) {
    ...
    this.cleanVariableExpr = bind(this.cleanVariableExpr, this);
  ...
  ExprCleaner.prototype.cleanExpr = function(expr, options) {
    ...
    if (options.table && expr.type !== "literal" && expr.type !== "variable" && expr.table !== options.table) {
      return null;
    }
    if (!expr.table && expr.type !== "literal" && expr.type !== "variable") {
      return null;
    }
