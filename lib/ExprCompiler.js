  ...
  (0, _createClass2["default"])(ExprCompiler, [{
    ...
    value: function compileExpr(options) {
      ...
      switch (expr.type) {
        ...
        case "spatial join":
          compiledExpr = this.compileSpatialJoinExpr(options);
          break;
    ...
    key: "compileSpatialJoinExpr",
    value: function compileSpatialJoinExpr(options) {
      var expr, query, radiusExpr;
      expr = options.expr;
      /* Sample:
      ...
      if (expr.filterExpr) {
        query.where.exprs.push(this.compileExpr({
