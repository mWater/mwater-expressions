var ExprCompiler, ExprUtils, _, injectTableAlias, injectTableAliases,
...
module.exports = ExprCompiler = (function() {
  ...
  ExprCompiler.prototype.compileScalarExpr = function(options) {
    var expr, extraWhere, from, i, j, join, limit, onClause, orderBy, ordering, ref, scalar, scalarExpr, table, tableAlias, where;
    expr = options.expr;
    where = null;
    from = null;
    orderBy = null;
  ...
  ExprCompiler.prototype.compileComparisonExpr = function(options) {
    var expr, exprUtils, exprs, lhsExpr, rhsExpr;
    expr = options.expr;
    exprUtils = new ExprUtils(this.schema);
    if (exprUtils.getComparisonRhsType(exprUtils.getExprType(expr.lhs), expr.op) && (expr.rhs == null)) {
      return null;
    }
