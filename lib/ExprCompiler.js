...
module.exports = ExprCompiler = class ExprCompiler {
  constructor(schema) {
            ...
            exprs: [
              {
                type: "op",
                op: "array_agg",
                exprs: [this.compileColumnRef(this.schema.getTable(column.join.toTable).primaryKey,
              "inner")]
              }
            ]
          },
    ...
    if (expr.aggr) {
      switch (expr.aggr) {
        case "last":
          ...
          orderBy = [
            {
              expr: this.compileColumnRef(ordering,
            tableAlias),
              direction: "desc"
            }
          ];
  ...
  compileOpExpr(options) {
    var compiledExprs, enumValues, expr, expr0Type, exprUtils, filterCompiled, idTable, innerrnQuery, lhsCompiled, orderBy, ordering, outerrnQuery, ref, ref1, ref2;
    exprUtils = new ExprUtils(this.schema);
    expr = options.expr;
    compiledExprs = _.map(expr.exprs, (e) => {
      return this.compileExpr({
        expr: e,
        tableAlias: options.tableAlias
      });
      ...
      case "within":
        ...
        return {
          ...
          exprs: [
            ...
            {
              type: "scalar",
              expr: this.compileColumnRef(this.schema.getTable(idTable).primaryKey,
            "subwithin"),
              from: {
                type: "table",
                table: idTable,
            ...
            "subwithin"),
              ...
              where: {
                ...
                exprs: [
                  ...
                  {
                    type: "literal",
                    value: _.map(compiledExprs[1].value,
                  (value) => {
                      if (_.isNumber(value)) {
                        return "" + value;
                      } else {
              ...
              exprs: [
                {
                  ...
                  op: ">=",
                  exprs: [compiledExprs[0],
                moment().startOf("year").subtract(1,
                'years').format("YYYY-MM-DD")]
                },
                {
                  type: "op",
              ...
              exprs: [
                {
                  ...
                  op: ">=",
                  exprs: [compiledExprs[0],
                moment().startOf("month").subtract(1,
                'months').format("YYYY-MM-DD")]
                },
                {
                  type: "op",
              ...
              exprs: [
                {
                  ...
                  op: ">=",
                  exprs: [compiledExprs[0],
                moment().startOf("day").subtract(30,
                'days').toISOString()]
                },
                {
                  type: "op",
              ...
              exprs: [
                {
                  ...
                  op: ">=",
                  exprs: [compiledExprs[0],
                moment().startOf("day").subtract(365,
                'days').toISOString()]
                },
                {
                  type: "op",
              ...
              exprs: [
                {
                  ...
                  exprs: [compiledExprs[0],
                moment().subtract(11,
                "months").startOf('month').format("YYYY-MM-DD")]
                },
                {
                  type: "op",
                  op: "<",
              ...
              exprs: [
                {
                  ...
                  exprs: [compiledExprs[0],
                moment().subtract(11,
                "months").startOf('month').toISOString()]
                },
                {
                  type: "op",
                  op: "<",
  ...
  compileCaseExpr(options) {
    ...
    compiled = {
      ...
      cases: _.map(expr.cases, (c) => {
        return {
          when: this.compileExpr({
            expr: c.when,
            tableAlias: options.tableAlias
          }),
          then: this.compileExpr({
            expr: c.then,
            tableAlias: options.tableAlias
          })
        };
