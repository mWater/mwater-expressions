                        ...
                        return {
                            ...
                            exprs: [
                                { type: "op", op: ">=", exprs: [compiledExprs[0], moment_1.default().startOf("year").format("YYYY-MM-DD")] },
                                {
                                    type: "op",
                                    op: "<",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("year").add(1, "years").format("YYYY-MM-DD")]
                                }
                            ]
                        };
                    case "datetime":
                        return {
                            ...
                            exprs: [
                                { type: "op", op: ">=", exprs: [compiledExprs[0], moment_1.default().startOf("year").toISOString()] },
                                {
                                    type: "op",
                                    op: "<",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("year").add(1, "years").toISOString()]
                                }
                            ]
                        };
                    default:
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("year").subtract(1, "years").format("YYYY-MM-DD")]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("year").format("YYYY-MM-DD")] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("year").subtract(1, "years").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("year").toISOString()] }
                            ]
                        };
                        ...
                        return {
                            ...
                            exprs: [
                                { type: "op", op: ">=", exprs: [compiledExprs[0], moment_1.default().startOf("month").format("YYYY-MM-DD")] },
                                {
                                    type: "op",
                                    op: "<",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("month").add(1, "months").format("YYYY-MM-DD")]
                                }
                            ]
                        };
                    case "datetime":
                        return {
                            ...
                            exprs: [
                                { type: "op", op: ">=", exprs: [compiledExprs[0], moment_1.default().startOf("month").toISOString()] },
                                {
                                    type: "op",
                                    op: "<",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("month").add(1, "months").toISOString()]
                                }
                            ]
                        };
                    default:
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("month").subtract(1, "months").format("YYYY-MM-DD")]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("month").format("YYYY-MM-DD")] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("month").subtract(1, "months").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("month").toISOString()] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("day").subtract(1, "days").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("day").toISOString()] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("day").subtract(7, "days").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("day").add(1, "days").toISOString()] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("day").subtract(30, "days").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("day").add(1, "days").toISOString()] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().subtract(365, "days").format("YYYY-MM-DD")]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().add(1, "days").format("YYYY-MM-DD")] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().startOf("day").subtract(365, "days").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("day").add(1, "days").toISOString()] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().subtract(11, "months").startOf("month").format("YYYY-MM-DD")]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().add(1, "days").format("YYYY-MM-DD")] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().subtract(11, "months").startOf("month").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("day").add(1, "days").toISOString()] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().subtract(5, "months").startOf("month").format("YYYY-MM-DD")]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().add(1, "days").format("YYYY-MM-DD")] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().subtract(5, "months").startOf("month").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("day").add(1, "days").toISOString()] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().subtract(2, "months").startOf("month").format("YYYY-MM-DD")]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().add(1, "days").format("YYYY-MM-DD")] }
                            ]
                        };
                            ...
                            exprs: [
                                {
                                    type: "op",
                                    op: ">=",
                                    exprs: [compiledExprs[0], moment_1.default().subtract(2, "months").startOf("month").toISOString()]
                                },
                                { type: "op", op: "<", exprs: [compiledExprs[0], moment_1.default().startOf("day").add(1, "days").toISOString()] }
                            ]
                        };
