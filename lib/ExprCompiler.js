...
class ExprCompiler {
    ...
    compileScalarExpr(options) {
        ...
        const generateAlias = (expr, joinIndex) => expr.joins[joinIndex].replace(/[^a-zA-Z0-9]/g, "_").toLowerCase();
        // Perform joins
        let { table } = expr;
                        ...
                        compiledExprs[0],
                        {
                            ...
                            where: {
                                ...
                                exprs: [
                                    ...
                                    { type: "literal", value: lodash_1.default.map(compiledExprs[1].value, value => {
