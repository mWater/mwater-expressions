...
class ExprUtils {
    ...
    getAggrTypes(expr) {
        ...
        const aggrOpItems = this.findMatchingOpItems({ lhsExpr: expr, aggr: true, ordered: (exprTable ? ((_a = this.schema.getTable(exprTable)) === null || _a === void 0 ? void 0 : _a.ordering) != null : false) });
...
for (const type of ['text', 'number', 'enum', 'enumset', 'boolean', 'date', 'datetime', 'geometry', 'id']) {
...
for (const type of ['text', 'number', 'enum', 'enumset', 'boolean', 'date', 'datetime', 'geometry', 'image', 'imagelist', 'id', 'json', 'dataurl']) {
