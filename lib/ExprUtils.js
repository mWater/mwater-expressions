...
module.exports = ExprUtils = (function() {
  function ExprUtils(schema) {
    var addOpItem, i, k, l, len, len1, len2, len3, m, op, ref, ref1, ref2, relativeDateOp, relativeDateOps, type;
    this.schema = schema;
    this.opItems = [];
  ...
  ExprUtils.prototype.getExprType = function(expr) {
    var aggr, column, opItems, resultTypes;
  ...
  ExprUtils.prototype.getExprAggrStatus = function(expr) {
    var exprs, getListAggrStatus, ref;
    if ((expr == null) || !expr.type) {
      return null;
    }
    ...
    switch (expr.type) {
      ...
      case "scalar":
        return "individual";
      case "op":
        if (ref = expr.op, indexOf.call(aggregateOps, ref) >= 0) {
          return "aggregate";
        }
