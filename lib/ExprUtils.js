var ExprUtils, _, addOpItem, aggrOpItems, i, k, l, len, len1, len2, len3, len4, len5, len6, len7, m, moment, n, o, op, opItems, p, q, ref, ref1, ref2, ref3, ref4, ref5, ref6, relativeDateOp, relativeDateOps, type,
    ...
    getListAggrStatus = (function(_this) {
      return function(exprs) {
        ...
        for (i = 0, len = exprs.length; i < len; i++) {
          subExpr = exprs[i];
          if (_this.getExprAggrStatus(subExpr, depth + 1) === "aggregate") {
            return "aggregate";
          }
        }
        for (k = 0, len1 = exprs.length; k < len1; k++) {
          subExpr = exprs[k];
          if (_this.getExprAggrStatus(subExpr, depth + 1) === "individual") {
            return "individual";
          }
        }
        for (l = 0, len2 = exprs.length; l < len2; l++) {
          subExpr = exprs[l];
          if (_this.getExprAggrStatus(subExpr, depth + 1) === "literal") {
            return "literal";
          }
        }
        return null;
...
addOpItem = (function(_this) {
  return function(item) {
    ...
    if (item.aggr) {
      return aggrOpItems[item.op] = true;
    }
  };
})(this);
