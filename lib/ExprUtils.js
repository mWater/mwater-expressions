...
module.exports = ExprUtils = (function() {
  function ExprUtils(schema) {
    var addOpItem, i, k, l, len, len1, len2, len3, len4, m, n, op, ref, ref1, ref2, ref3, relativeDateOp, relativeDateOps, type;
    this.schema = schema;
    this.opItems = [];
    ...
    ref3 = ['text', 'number', 'enum', 'enumset', 'boolean', 'date', 'datetime', 'geometry', 'image', 'imagelist', 'id'];
  ...
  ExprUtils.prototype.getExprType = function(expr) {
    var column, opItems, resultTypes;
