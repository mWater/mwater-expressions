...
module.exports = ExprUtils = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ExprUtils, [{
    ...
    value: function getExprEnumValues(expr) {
      ...
      if (expr.type === "op" && ((ref = expr.op) === "last" || ref === "last where" || ref === "previous" || ref === "first" || ref === "first where") && expr.exprs[0]) {
      ...
      if (expr.type === "variable") {
        return (ref2 = this.schema.getVariable(expr.variableId)) != null ? ref2.enumValues : void 0;
      }
    ...
    value: function getExprIdTable(expr) {
      ...
      if (expr.type === "variable") {
        return (ref2 = this.schema.getVariable(expr.variableId)) != null ? ref2.idTable : void 0;
      }
    ...
    value: function getExprType(expr) {
      ...
      switch (expr.type) {
        ...
        case "variable":
          variable = this.schema.getVariable(expr.variableId);
      ...
      switch (expr.type) {
        ...
        case "field":
          ...
          if (column != null ? column.expr : void 0) {
            ...
            return exprAggrStatusWeakCache.cacheFunction([this.schema, column.expr], [], function () {
    ...
    value: function inlineVariableValues(expr, variableValues) {
      ...
      _replacer = function replacer(part) {
        var literalValue, variable;
        part = mapObject(part, _replacer);

        if (part && part.type === "variable") {
          // Find variable
          variable = _this4.schema.getVariable(part.variableId);
