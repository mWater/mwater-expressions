  ...
  (0, _createClass2["default"])(ExprUtils, [{
    ...
    value: function findMatchingOpItems(search) {
      ...
      return _.filter(items, function (opItem) {
        ...
        if (search.lhsExpr) {
          lhsType = _this.getExprType(search.lhsExpr); // if lhsType and ((opItem.exprTypes[0] != null and opItem.exprTypes[0] != lhsType) or (opItem.exprTypes[0] == null and opItem.moreExprType != lhsType))
