...
module.exports = ExprUtils = (function() {
  function ExprUtils(schema) {
    var addOpItem, i, k, l, len, len1, len2, len3, len4, len5, m, n, o, op, ref, ref1, ref2, ref3, ref4, relativeDateOp, relativeDateOps, type;
    this.schema = schema;
    this.opItems = [];
  ...
  ExprUtils.prototype.getExprType = function(expr) {
    var column, opItems, ref, resultTypes;
