...
module.exports = ExprUtils = (function() {
  ...
  ExprUtils.prototype.summarizeExpr = function(expr, locale) {
    var opItem, ref, ref1, ref2, ref3, ref4;
    if (!expr) {
      return "None";
    }
    switch (expr.type) {
      ...
      case "op":
        ...
        if (expr.op === "=" && ((ref3 = expr.exprs[1]) != null ? ref3.type : void 0) === "literal" && ((ref4 = expr.exprs[1]) != null ? ref4.valueType : void 0) === "enum") {
          return this.summarizeExpr(expr.exprs[0], locale) + " is " + this.stringifyExprLiteral(expr.exprs[0], expr.exprs[1].value, locale);
        }
        if (expr.op === "count") {
...
addOpItem({
  ...
  desc: "Advanced: convert an choice type to a text value",
  resultType: "text",
  exprTypes: ["enum"],
  prefix: true
});
