...
module.exports = ExprUtils = (function() {
  ...
  ExprUtils.prototype.findOpByResultType = function(resultType, exprTypes) {
    var opItems;
        ...
        if (search.exprTypes) {
          ...
          for (i = k = 0, len = ref.length; k < len; i = ++k) {
            ...
            if (i < opItem.exprTypes.length) {
              if (exprType && exprType !== opItem.exprTypes[i]) {
                return false;
              }
  ...
  ExprUtils.prototype.getExprValues = function(expr) {
    var column;
    if (expr.type === "field") {
  ...
  ExprUtils.prototype.summarizeExpr = function(expr) {
    if (!expr) {
      return "None";
    }
    switch (expr.type) {
  ...
  ExprUtils.prototype.summarizeScalarExpr = function(expr) {
  ...
  ExprUtils.prototype.summarizeAggrExpr = function(expr, aggr) {
  ...
  ExprUtils.prototype.stringifyExprLiteral = function(expr, literal) {
    var item, values;
    if (literal == null) {
      return "None";
    }
