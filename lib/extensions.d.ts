...
export interface ExprExtension<T extends ExtensionExpr> {
    ...
    evaluateSync(expr: Expr, schema: Schema | undefined, locale: string | undefined, variables: Variable[] | undefined, variableValues: {
        [variableId: string]: any;
    } | undefined): any;
}
 ...
 */
export declare function registerExprExtension(id: string, extension: ExprExtension<ExtensionExpr>): void;
export declare function getExprExtension(id: string): ExprExtension<ExtensionExpr>;
