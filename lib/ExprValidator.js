                ...
                case "op":
                    ...
                    for (const subexpr of expr.exprs) {
                        ...
                        if (ExprUtils_1.default.isOpAggr(expr.op)) {
                            ...
                            error = this.validateExprInternal(subexpr, Object.assign(Object.assign({}, lodash_1.default.omit(options, "types", "enumValueIds", "idTable")), { aggrStatuses: lodash_1.default.union(aggrStatuses, ["literal"]) }));
                        }
                        if (error) {
                            return error;
                        }
