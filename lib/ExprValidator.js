        ...
        this.validateExprInternal = function (expr, options) {
            ...
            switch (expr.type) {
                ...
                case "op":
                    ...
                    var hasIndividual = false, hasAggregate = false;
                    for (var _b = 0, _c = expr.exprs; _b < _c.length; _b++) {
                        var subexpr = _c[_b];
                        var aggrStatus_1 = _this.exprUtils.getExprAggrStatus(subexpr);
                        hasIndividual = hasIndividual || (aggrStatus_1 == "individual");
                        hasAggregate = hasAggregate || (aggrStatus_1 == "aggregate");
                    }
                ...
                case "case":
                    // Validate cases
                    for (var _d = 0, _e = expr.cases; _d < _e.length; _d++) {
                        var cse = _e[_d];
            ...
            var type = _this.exprUtils.getExprType(expr);
