...
module.exports = MWaterDataSource =
/*#__PURE__*/
function (_DataSource) {
  ...
  function MWaterDataSource(apiUrl, client) {
    ...
    _this = (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(MWaterDataSource).call(this));
    _this.apiUrl = apiUrl;
  ...
  (0, _createClass2["default"])(MWaterDataSource, [{
    ...
    value: function performQuery(jsonql, cb) {
      ...
      url = this.apiUrl + "jsonql?" + querystring.stringify(queryParams); // Setup caching
