...
module.exports = MWaterDataSource = /*#__PURE__*/function (_DataSource) {
  ...
  (0, _createClass2["default"])(MWaterDataSource, [{
    ...
    value: function performQuery(jsonql, cb) {
      ...
      var cacheKey, cachedRows, headers, jsonqlStr, method, queryParams, seconds, url; // If no callback, use promise

      if (!cb) {
        return new Promise(function (resolve, reject) {
          return _this2.performQuery(jsonql, function (error, rows) {
            if (error) {
              return reject(error);
            } else {
              return resolve(rows);
