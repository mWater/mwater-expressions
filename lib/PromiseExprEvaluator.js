...
class PromiseExprEvaluator {
    ...
    evaluate(expr, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (expr.type) {
                ...
                case "extension":
                    return yield (0, extensions_1.getExprExtension)(expr.extension).evaluate(expr, context, this.schema, this.locale, this.variables, this.variableValues);
                default:
    ...
    evaluateSync(expr) {
        ...
        switch (expr.type) {
            ...
            case "extension":
                return (0, extensions_1.getExprExtension)(expr.extension).evaluateSync(expr, this.schema, this.locale, this.variables, this.variableValues);
            default:
                throw new Error(`Unsupported expression type ${expr.type}`);
        }
    }
    ...
    evaluateOpValues(op, exprs, values) {
        ...
        switch (op) {
            ...
            case "days difference":
                ...
                return (0, moment_1.default)(v0, moment_1.default.ISO_8601).diff((0, moment_1.default)(v1, moment_1.default.ISO_8601)) / 24 / 3600 / 1000;
            case "months difference":
                ...
                v0 = values[0].length == 10 ? values[0] + "T00:00:00Z" : values[0];
                v1 = values[1].length == 10 ? values[1] + "T00:00:00Z" : values[1];
                return (0, moment_1.default)(v0, moment_1.default.ISO_8601).diff((0, moment_1.default)(v1, moment_1.default.ISO_8601)) / 24 / 3600 / 1000 / 30.5;
            case "years difference":
                ...
                v0 = values[0].length == 10 ? values[0] + "T00:00:00Z" : values[0];
                v1 = values[1].length == 10 ? values[1] + "T00:00:00Z" : values[1];
                return (0, moment_1.default)(v0, moment_1.default.ISO_8601).diff((0, moment_1.default)(v1, moment_1.default.ISO_8601)) / 24 / 3600 / 1000 / 365;
            case "days since":
                if (hasNull) {
                    return null;
                }
                return (0, moment_1.default)().diff((0, moment_1.default)(values[0], moment_1.default.ISO_8601)) / 24 / 3600 / 1000;
            case "weekofmonth":
                if (hasNull) {
                    return null;
                }
                return Math.floor(((0, moment_1.default)(values[0], moment_1.default.ISO_8601).date() - 1) / 7) + 1 + ""; // Make string
            case "dayofmonth":
                if (hasNull) {
                    return null;
                }
                return (0, moment_1.default)(values[0], moment_1.default.ISO_8601).format("DD");
            case "month":
                if (hasNull) {
                    return null;
                }
            ...
            case "yearquarter":
                ...
                return values[0].substr(0, 4) + "-" + (0, moment_1.default)(values[0].substr(0, 10), "YYYY-MM-DD").quarter();
            case "yearweek":
                if (hasNull) {
                    return null;
                }
                const isoWeek = (0, moment_1.default)(values[0].substr(0, 10), "YYYY-MM-DD").isoWeek();
                return values[0].substr(0, 4) + "-" + (isoWeek < 10 ? "0" + isoWeek : isoWeek);
            case "weekofyear":
                if (hasNull) {
                    return null;
                }
                const isoWeek2 = (0, moment_1.default)(values[0].substr(0, 10), "YYYY-MM-DD").isoWeek();
            ...
            case "today":
                ...
                date = values[0];
                return (0, moment_1.default)(date, moment_1.default.ISO_8601).format("YYYY-MM-DD") === (0, moment_1.default)().format("YYYY-MM-DD");
            case "yesterday":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return (0, moment_1.default)(date, moment_1.default.ISO_8601).add(1, "days").format("YYYY-MM-DD") === (0, moment_1.default)().format("YYYY-MM-DD");
            case "thismonth":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return (0, moment_1.default)(date, moment_1.default.ISO_8601).format("YYYY-MM") === (0, moment_1.default)().format("YYYY-MM");
            case "lastmonth":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return (0, moment_1.default)(date, moment_1.default.ISO_8601).add(1, "months").format("YYYY-MM") === (0, moment_1.default)().format("YYYY-MM");
            case "thisyear":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return (0, moment_1.default)(date, moment_1.default.ISO_8601).format("YYYY") === (0, moment_1.default)().format("YYYY");
            case "lastyear":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return (0, moment_1.default)(date, moment_1.default.ISO_8601).add(1, "years").format("YYYY") === (0, moment_1.default)().format("YYYY");
            case "last24hours":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return ((0, moment_1.default)(date, moment_1.default.ISO_8601).isSameOrBefore((0, moment_1.default)()) &&
                    (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)().subtract(24, "hours")));
            case "last7days":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return ((0, moment_1.default)(date, moment_1.default.ISO_8601).isBefore((0, moment_1.default)().add(1, "days")) &&
                    (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)().subtract(7, "days")));
            case "last30days":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return ((0, moment_1.default)(date, moment_1.default.ISO_8601).isBefore((0, moment_1.default)().add(1, "days")) &&
                    (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)().subtract(30, "days")));
            case "last365days":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return ((0, moment_1.default)(date, moment_1.default.ISO_8601).isBefore((0, moment_1.default)().add(1, "days")) &&
                    (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)().subtract(365, "days")));
            case "last12months":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return ((0, moment_1.default)(date, moment_1.default.ISO_8601).isBefore((0, moment_1.default)().add(1, "days")) &&
                    (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)().subtract(11, "months").startOf("month")));
            case "last6months":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return ((0, moment_1.default)(date, moment_1.default.ISO_8601).isBefore((0, moment_1.default)().add(1, "days")) &&
                    (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)().subtract(5, "months").startOf("month")));
            case "last3months":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return ((0, moment_1.default)(date, moment_1.default.ISO_8601).isBefore((0, moment_1.default)().add(1, "days")) &&
                    (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)().subtract(2, "months").startOf("month")));
            case "future":
                if (hasNull) {
                    return null;
                }
                date = values[0];
                return (0, moment_1.default)(date, moment_1.default.ISO_8601).isAfter((0, moment_1.default)());
            case "notfuture":
                if (hasNull) {
                    return null;
                }
