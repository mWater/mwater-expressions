                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case "literal": return [3 /*break*/, 4];
                            case "op": return [3 /*break*/, 5];
                            case "id": return [3 /*break*/, 7];
                            case "case": return [3 /*break*/, 8];
                            case "scalar": return [3 /*break*/, 10];
                            case "score": return [3 /*break*/, 12];
                            case "build enumset": return [3 /*break*/, 14];
                            case "variable": return [3 /*break*/, 16];
                        }
                        return [3 /*break*/, 18];
                    case 1:
                    ...
                    case 3:
                        ...
                        // Get field from row
                        return [2 /*return*/, context.row.getField(expr.column)];
                    case 4: return [2 /*return*/, expr.value];
                    case 5: return [4 /*yield*/, this.evaluateOp(expr.table, expr.op, expr.exprs, context)];
                    ...
                    case 8: return [4 /*yield*/, this.evaluateCase(expr, context)];
                    case 9: return [2 /*return*/, _b.sent()];
                    case 10: return [4 /*yield*/, this.evaluateScalar(expr, context)];
                    case 11: return [2 /*return*/, _b.sent()];
                    case 12: return [4 /*yield*/, this.evaluateScore(expr, context)];
                    case 13: return [2 /*return*/, _b.sent()];
                    case 14: return [4 /*yield*/, this.evaluateBuildEnumset(expr, context)];
                    case 15: return [2 /*return*/, _b.sent()];
                    case 16: return [4 /*yield*/, this.evaluateVariable(expr, context)];
                    case 17: return [2 /*return*/, _b.sent()];
                    case 18: throw new Error("Unsupported expression type " + expr.type);
                }
            });
        });
    };
